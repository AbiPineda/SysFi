                ...
                <div class="col-md-12" >
                              ...
                              <div class="col-md-12">
                                    <form class="form-horizontal" role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" name="nombre" <?php //echo $row['nombre']; ?>">
                                            </div>
                                        </div>
                             ...
                             <div class="col-md-12">
                                    <form class="form-horizontal" role="form">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" class="form-control"<?php //echo $dir; ?>" name="dir">
                                            </div>

                                       
                                            <label class="col-md-1 control-label">DUI:</label>
                                            <div class="col-md-2">
                                                <input type="text" class="form-control" <?php //echo $dir; ?>" name="dui">
                                            </div>
                                            ...
                                            <div class="col-md-2">
                                                <input type="text" class="form-control" placeholder="Ej: 9999-9999" data-mask="9999-9999" autocomplete="off">
                                            </div>
