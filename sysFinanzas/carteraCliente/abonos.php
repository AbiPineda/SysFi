...
$facuras = mysqli_query($conexion, "SELECT * FROM contable WHERE id_contable='$cuenta'");
    while ($filita = mysqli_fetch_array($facuras)) {
        $factu=$filita['concepto2'];
    }
?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-7">
                                                    <table id="tabla" class="table table-striped table-bordered table-hover">
                                                        ...
                                                        <tbody class="buscar">
                                                    <?php
                                                    $sacarAr = mysqli_query($conexion, "SELECT articulos.nombre, articulos.codigo FROM detalle "
                                                            . "INNER JOIN articulos ON detalle.articulo=articulos.idarticulos WHERE factura='$factu'");
                                                    while ($fila = mysqli_fetch_array($sacarAr)) {
                                                        $cod = $fila['codigo'];
                                                        $ar = $fila['nombre'];
