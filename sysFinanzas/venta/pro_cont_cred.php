...
if(!empty($_GET['valor_recibido']) and !empty($_GET['neto'])){
        ...
        $pa=mysqli_query($conexion,"SELECT * FROM ventaC_temp");             
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
               <table width="95%" rules="all" border="1">
                            <?php 
                                                $item=0;
                                                $pa=mysqli_query($conexion,"SELECT * FROM clientcred_tmp, tb_cliente 
                                                WHERE  clientcred_tmp.id_cliente=tb_cliente.id_cliente");             
...
//                                                }
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                        ...
                        <?php }?>
                            ...
                            <?php 
                                    $n=mysqli_query($conexion,"SELECT * FROM clientcred_tmp");               
                            ...
                            <table class="table" width="425px" style="border: 1px dotted #FFFFFF; -moz-border-radius: 12px;-webkit-border-radius: 12px;padding: 10px;">
                                            <?php 
                                                ...
                                                $pa=mysqli_query($conexion,"SELECT * FROM ventaC_temp, inventario 
                                                WHERE  ventaC_temp.id_articulo=inventario.id_articulos");             
                                                while($row=mysqli_fetch_array($pa)){                                             
                                                    $cat=$row['cantidad'];   
                                                    ...
                                                    $importe_dos=$row['cantidad']*$new+$iva;
                        ...
                        while($rowCon=mysqli_fetch_array($consultaAr)){
                            ...
                            $costo=$rowCon['valor'];
                                        ...
                                        <table class="table" width="450px" style="border: 0px dotted #FFFFFF; -moz-border-radius: 12px;-webkit-border-radius: 12px;padding: 12px;">
                                          <tr>
                                               <td colspan="4" align="right" class="text-default" style="font-size: 16px;">&nbsp;&nbsp;&nbsp;<?php echo formato($netoO-$iva); ?></td>
                                            </tr>
                                         <tr>
                                               <td colspan="4" align="right" class="text-danger" style="font-size: 16px;">&nbsp;&nbsp;&nbsp;<?php echo formato($iva); ?></td>
                                            </tr>
                                            <tr>
       ...
       mysqli_query($conexion,"DELETE FROM ventaC_temp");
       mysqli_query($conexion,"DELETE FROM clientcred_tmp");
    ?>    
