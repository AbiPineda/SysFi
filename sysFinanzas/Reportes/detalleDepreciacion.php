...
INNER JOIN clasificacion ON tipo_activo.idclasificacion = clasificacion.id_clasificacion
 ...
 WHERE activo.idactivo='$modi'");
	...
	$pdf->Cell(40,6,utf8_decode('Vida útil (Años)'),0,0,'C',1);
	$pdf->Image('images/etiqueta.png', 115, 88, 6 );
	$pdf->Cell(40,6,utf8_decode('Vida útil (Meses)'),0,1,'C',1);
	$pdf->Image('images/etiqueta.png', 153, 88, 6 );


	$pdf->SetFont('Arial','',11);
	$pdf->Cell(55,6,utf8_decode($encargado . " " . $apellidos),0,0,'L',0);
	$pdf->Cell(50,6,utf8_decode($departamento),0,0,'C',0);
	$pdf->Cell(40,6,utf8_decode($vidautil),0,0,'C',0);
	$pdf->Cell(40,6,utf8_decode($meses),0,1,'C',0);

	$pdf->Ln(10);
	$pdf->Cell(80,6,utf8_decode('Método de Línea Recta - Depreciación Anual'),0,1,'L',0);
	$pdf->Ln(7);
	$pdf->SetX(20);
